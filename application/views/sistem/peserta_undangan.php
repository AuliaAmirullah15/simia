      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="#" data-toggle="modal" data-target="#pesertaModal" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Tambah data</a>
          </div>
  ...
  <strong>Selamat!</strong> <?= $message ?>
          ...
          <div class="row">
            ...
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Administrasi Kegiatan Fasilkom-TI</h6>
            </div>
                <div class="card-body">
                      <!-- DataTales Example -->
                  ...
                  <tfoot>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="<?php echo base_url('Administrasi/hapus_data/adm_peserta_undangan/'. $d->id_peserta); ?>" class="btn btn-danger btn-circle" onclick="return confirm('Apakah anda yakin data ini dihapus?')">
