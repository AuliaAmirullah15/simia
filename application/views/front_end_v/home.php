        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-12 hero-text-image" style="padding-top: 70px;">
              <div class="row">
                    <div class="col-lg-12">
                        <center><h1 data-aos="fade-right">Layanan Aspirasi dan Pengaduan Online Fasilkom-TI USU</h1>
                        ...
                        <div class="col-lg-12 shadow p-3 mb-5 bg-white">
                           <form id="regForm" name="lapor-form" method="post" action="<?php echo base_url().'Home/lapor_kerusakan';?>" enctype="multipart/form-data">
                            
                             <div class="col-sm-12"> <h6>Pilih Status Anda Sebagai Pelapor:</h6>
                                ...
                                <div class="d-flex flex-row-reverse">
                                 <button class="btn btn-info" style="margin-top: 20px;" type="submit">Pilih</button>
                                 </div>
