            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="contact-form bottom">
                        <form id="regForm" name="contact-form" method="post" action="<?php echo base_url().'Home/lapor_kerusakan';?>" enctype="multipart/form-data">
                            
                             <div class="col-sm-12"> <h2>Pilih Status Anda Sebagai Pelapor:</h2></div>
